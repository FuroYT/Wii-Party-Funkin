...
class WeekData {
	...
	public static function addSourceWeek(week:WeekFile) {
		if(week != null) {
			var weekFile:WeekData = new WeekData(week, week.weekName);

			if(weekFile != null && !weekFile.hideFreeplay) {
				weeksLoaded.set(week.weekName, weekFile);
				weeksList.push(week.weekName);
			}
		}
	}
