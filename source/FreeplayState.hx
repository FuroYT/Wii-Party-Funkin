...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var leText:String = #if debug "Press CTRL to open the Gameplay Changers Menu / " + #end "Press RESET to Reset your Score and Accuracy.";
		var size:Int = #if debug 18 #else 24 #end ;
